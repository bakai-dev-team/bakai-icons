...
| `passport_front`         | Иконка передней части паспорта      |
| `passport_back`          | Иконка задней части паспорта        |
| `copy`                   | Иконка копирования                  |
| `passengers`             | Иконка пассажиров                   |
| `heart`                  | Иконка сердца                       |
| `tariff`                 | Иконка тарифа                       |
